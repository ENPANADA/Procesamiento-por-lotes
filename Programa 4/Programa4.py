...
"")
    ...
    def LlenadoDeDatos(self):
        global Programadores,BanderaProcesos,CantProcesosBloqueados,ContadorGlobal,ContadorMinioms
    ...
    def RestablecerValores(self):
        global Programadores,ContadorGlobal,BanderaProcesos,LotesTerminados,Pos_lote,BanderaEjecucion,Bandera_Error,Bandera_P_C,BanderaInterrupcion,CantidadLotesTerminados,ContadorMinioms
        if BanderaProcesos:
            Programadores=0
            ContadorMinioms=0
            ContadorGlobal=0
