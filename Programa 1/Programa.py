...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_superior.setMinimumSize(QtCore.QSize(0, 41))
...
"")
    ...
    def ReclutarProgramadores(self):
        global ContadorMinioms,Programadores
        SubLote=[]
        SubLote.append(int(self.lineEdit_3.text()))
        SubLote.append(self.lineEdit_4.text())
        SubLote.append(self.lineEdit_5.text())
        SubLote.append(int(self.lineEdit_6.text()))
