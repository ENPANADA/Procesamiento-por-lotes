...
"}")
        ...
        self.Procesos_2 = QtWidgets.QPushButton(self.MenuDesplegable)
        self.Procesos_2.setMinimumSize(QtCore.QSize(135, 45))
        self.Procesos_2.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
        self.Procesos_2.setObjectName("Procesos_2")
        self.verticalLayout.addWidget(self.Procesos_2)
...
"}")
        ...
        self.verticalLayout_14 = QtWidgets.QVBoxLayout(self.page_Procesos)
...
"")
        ...
        spacerItem20 = QtWidgets.QSpacerItem(20, 14, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"")
        ...
        spacerItem21 = QtWidgets.QSpacerItem(20, 14, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
...
"")
        ...
        self.pushButton = QtWidgets.QPushButton(self.page_Procesos)
        self.pushButton.setMinimumSize(QtCore.QSize(135, 45))
        ...
        self.page_Finalizados = QtWidgets.QWidget()
        self.page_Finalizados.setObjectName("page_Finalizados")
        self.verticalLayout_15 = QtWidgets.QVBoxLayout(self.page_Finalizados)
        ...
        self.label_18 = QtWidgets.QLabel(self.page_Finalizados)
        self.label_18.setStyleSheet("font: 77 20pt \"Arial Black\";")
        ...
        self.tableWidget = QtWidgets.QTableWidget(self.page_Finalizados)
        ...
        self.tableWidget.setMinimumSize(QtCore.QSize(346, 200))
        self.tableWidget.setMaximumSize(QtCore.QSize(346, 600))
        ...
        self.label_19 = QtWidgets.QLabel(self.page_Finalizados)
        ...
        self.lineEdit_22 = QtWidgets.QLineEdit(self.page_Finalizados)
...
"")
        ...
        self.pushButton_8 = QtWidgets.QPushButton(self.page_Finalizados)
        ...
        spacerItem33 = QtWidgets.QSpacerItem(20, 14, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_15.addItem(spacerItem33)
        self.stackedWidget.addWidget(self.page_Finalizados)
        ...
        self.Procesos_2.clicked.connect(lambda: self.MostrarPestañaFinalizados())
        ...
        self.lineEdit_4.textChanged.connect(lambda: self.EstadoInicial4())
        self.lineEdit_5.textChanged.connect(lambda: self.EstadoInicial5())
        self.lineEdit_6.textChanged.connect(lambda: self.EstadoInicial6())
        #PaginaProcesos
        self.pushButton.clicked.connect(lambda: self.MostrarPestañaTerminados())
        #PaginaFinalizados
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.Procesos_2.setText(_translate("MainWindow", "Finalizados"))
    ...
    def MostrarPestañaFinalizados(self):
        self.stackedWidget.setCurrentWidget(self.page_Finalizados)
    ...
    def PesstañaAsignar_Boton(self):
        ...
        if Programadores!=0:
            ...
            return
        try:
            Programadores=int(self.lineEdit_2.text())
        except:
            self.lineEdit_2.setStyleSheet("border-bottom:2px solid red;")
            return
    ...
    def ReclutarProgramadores(self):
        ...
        try:
            ...
            #Se deberia de guardar el resultado antes de procesarlo? xd
    ...
    def ProcesarDatos(self,x):
        ...
        fin=default_timer()
        TT=fin-inicio
        self.lineEdit_11.setText('{:.2f}'.format(TT))
        self.aMimir2()
        self.lineEdit_12.setText('{:.2f}'.format(Lotes[x][3]-TT))
        self.aMimir()
    ...
    def LlenadoDeDatos(self):
        ...
        self.stackedWidget.setCurrentWidget(self.page_Finalizados)
    def MostrarPestañaTerminados(self):
        self.stackedWidget.setCurrentWidget(self.page_Finalizados)
    
    #PaginaFinalizados
    def ProcesosFinalizados(self,Pos,ID,Operacion):
        self.tableWidget.setRowCount(Pos+1)
        self.tableWidget.setItem(Pos, 0, QtWidgets.QTableWidgetItem('{}'.format(ID)))
        self.tableWidget.setItem(Pos, 1, QtWidgets.QTableWidgetItem(Operacion))
        self.tableWidget.setItem(Pos, 2, QtWidgets.QTableWidgetItem('{}'.format(eval(Operacion))))
    def ContadorGlobal(self,x):
        global ContadorGlobal
        ContadorGlobal+=x
        self.lineEdit_22.setText('{:.2f}'.format(ContadorGlobal))
    def RestablecerValores(self):
        global Programadores,ContadorMinioms,ContadorGlobal,Flag
        if Flag:
            Programadores=0
            ContadorMinioms=0
            ContadorGlobal=0
