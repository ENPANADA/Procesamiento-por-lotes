...
"}")
        ...
        self.lineEdit_21.setMaximumSize(QtCore.QSize(80, 35))
...
"")
        ...
        self.lineEdit_22.setMinimumSize(QtCore.QSize(100, 35))
        self.lineEdit_22.setMaximumSize(QtCore.QSize(100, 35))
...
"")
    ...
    def ReclutarProgramadores(self):
        ...
        if Programadores==ContadorMinioms:
            self.stackedWidget.setCurrentWidget(self.page_Procesos)
            '''
            Comenzar el procesado de datos
            '''
            return
        self.ReclutarProgramadores_Title()
