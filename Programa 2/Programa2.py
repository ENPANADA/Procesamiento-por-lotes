...
"")
    ...
    def GeneradorDeMinioms(self):
        ...
        for x in range(Programadores):
            ...
            self.aMimir(50)
            self.lineEdit_5.setText('{}{}{}'.format(random.randint(1, 100),random.choice(Operadores),random.randint(1, 100)))
            self.aMimir(50)
    ...
    def ProcesarDatos(self,x):
        ...
        for i in range(Lotes[x][3]):
            ...
            if BanderaInterrupcion:
                pass
                #Revisar si la BanderaEjecucion sigue activa
            if SumTT>=0:
    ...
    def RestablecerValores(self):
        global Programadores,ContadorMinioms,ContadorGlobal,BanderaProcesos,LotesTerminados,Pos_lote,BanderaEjecucion,Bandera_Error,Bandera_P_C,BanderaInterrupcion
        if BanderaProcesos:
            Programadores=0
            ContadorMinioms=0
            ContadorGlobal=0
